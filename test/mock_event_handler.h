...
class MockEventHandler : public EventHandler {
 public:
  ...
  MOCK_METHOD4(OnScalar, void(const Mark&, std::string, anchor_t,
                              std::string));

  MOCK_METHOD4(OnSequenceStart, void(const Mark&, std::string, anchor_t,
                                     EmitterStyle::value));
  MOCK_METHOD0(OnSequenceEnd, void());

  MOCK_METHOD4(OnMapStart, void(const Mark&, std::string, anchor_t,
                                EmitterStyle::value));
